...
description: Apply when creating, refactoring, modifying, planning (plan mode) or reviewing any file that is an HTTP controller, REST endpoint, API adapter, or global exception handler. 
---
