...
description: Apply when creating, modifying, or reviewing any file that implements a repository (classes with names containing `Repository`, implementing an interface which name contains `Repository`, or classes that abstract data access to a database or external storage)
---
